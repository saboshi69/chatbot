...
export async function POST(req: Request) {
  ...
  const instructions = [
    ...
    },
    {
      role: "assistant",
      content:
        "Please help to paraphrase the following content. The length of paraphrased text and the meaning of the paraphrased text should be similar to the original one.",
    },
  ];
